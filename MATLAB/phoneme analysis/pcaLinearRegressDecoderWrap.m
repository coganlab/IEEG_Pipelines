function [ytestAll,ypredAll,optimDimAll] = pcaLinearRegressDecoderWrap(ieegSplit,labels,tw,etw,varVector,numFolds)
...
accVectAll = [];
if(numFolds>0)
    cvp = cvpartition(length(labels),'KFold',numFolds);
else
