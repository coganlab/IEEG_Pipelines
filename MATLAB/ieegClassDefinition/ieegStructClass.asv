classdef ieegStructClass
    ...
    methods
        ...
        function ieegHiGamma = extractHiGamma(obj,fDown,gtw,normFactor) % Extracting high-gamma signal           
            ...
            for iTrial = 1:size(obj.data,2)            
                [~,ieegGammaTemp(:,iTrial,:)] = EcogExtractHighGammaTrial(double(squeeze(dataTemp(:,iTrial,:))),fsTemp,fDown,fGamma,twTemp,gtw,normFactor,2);
            end
